...
{
    [CreateAssetMenu(fileName = "ScriptableControllerStats", menuName = "Scriptable Objects/ScriptableControllerStats")]
    public class ScriptableControllerStats : ScriptableObject
    {
        [Header("LAYERS")]
